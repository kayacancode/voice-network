...
import { Mic, MicOff, Loader, Play, Square, Search } from "lucide-react";
        ...
        <div className="flex flex-col items-center space-y-4">
          {!isConnected ? (
            ...
            >
              <Button
                size="lg"
                disabled={isThinking || isSpeaking || isSearching}
          ...
          <div className="text-center space-y-1">
            ...
            <p className="text-sm text-muted-foreground max-w-xs">
              {!isConnected ? "Connect to start voice searching your network" :
               ...
               isSearching ? "Looking through your network database..." :
               isThinking ? "Analyzing your request and preparing search..." :
               isSpeaking ? "AI assistant is responding with results" :
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="font-medium text-blue-700 dark:text-blue-300">
                  Agent coordinating search...
                </div>
                <div className="text-sm text-blue-600 dark:text-blue-400">
                  Voice assistant is searching database and preparing response
                </div>
              </div>
            </div>
          </motion.div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="text-sm text-green-600 dark:text-green-400">
                  Voice assistant has the same results • Ask a follow-up question anytime
                </div>
              </div>
            </div>
          </motion.div>
