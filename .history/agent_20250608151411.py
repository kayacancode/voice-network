...
async def entrypoint(ctx: agents.JobContext):
    ...
    await session.generate_reply(
        instructions="""Greet the user and let them know you can help them search their professional network. 
        
        You have access to their LinkedIn contacts and Instagram followers. You can help them find people by:
        - Name (e.g., "Find John Smith")  
        - Job title (e.g., "Show me designers" or "Find software engineers")
        - Company (e.g., "Who do I know at Google?")
        - Location (e.g., "Find people in San Francisco")
        - Skills or industry (e.g., "Show me React developers")
        
        Ask them what kind of contacts they're looking for!"""
    )
