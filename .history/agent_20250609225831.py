...
IMPORTANT: Always search the actual database for any user query. Never make up information. If no results are found, simply say "No information found" and suggest trying a different search term."""
        )
